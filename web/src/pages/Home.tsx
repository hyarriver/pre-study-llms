    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center pt-20 pb-16 space-y-8">
          {/* 标签 */}
          <div className="inline-flex items-center px-4 py-2 rounded-full glass-card text-sm text-blue-400">
        ...
        <div className="grid gap-6 md:grid-cols-3 py-12">
          <div className="feature-card p-6 hover:scale-105 transition-all duration-300">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground">系统教程</h3>
            </div>
          ...
          <div className="feature-card p-6 hover:scale-105 transition-all duration-300">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground">实践导向</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="feature-card p-6 hover:scale-105 transition-all duration-300">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground">前沿技术</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed">
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-base font-semibold text-foreground group-hover:text-blue-300 transition-colors truncate">
                        {chapter.title}
                      </h3>
        ...
        <div className="py-16 text-center">
          <div className="glass-card rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold mb-4 gradient-text">准备好开始学习了吗？</h3>
